! This subroutine is from "Computation of Special Functions" by
!  Shanjie Zhang and Jianming Jin.  This was specifically downloaded
!  from their website at http://jin.ece.uiuc.edu/specfunc.html
C
C       ============================================================
