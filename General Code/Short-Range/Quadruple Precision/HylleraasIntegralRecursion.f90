...
! Helper function to tell PreCalcGamma how large sm needs to be. This takes into account the
!  extra r1, r2 and r3 that come from the nonlinear parameter optimization.
integer function PreCalcGammaSize(Omega)
	implicit none
	integer Omega

	PreCalcGammaSize = 6 + Omega * 2
	return
end
